import { g as getCloudflareContext, a as getDB, b as squareExports, p as payments, u as users, e as eq, s as serviceRequests, r as registerServerReference } from "./worker-entry-D7PYXyDz.js";
...
async function processPayment({ sourceId, amount = 9900, customerDetails }) {
  try {
    ...
    try {
      const { revalidatePath } = await import("./worker-entry-D7PYXyDz.js").then((n) => n.v);
