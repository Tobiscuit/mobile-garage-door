import { g as getCloudflareContext, a as getDB, b as squareExports, p as payments, u as users, e as eq, s as serviceRequests, r as registerServerReference } from "./worker-entry--gchsNuF.js";
...
async function processPayment({ sourceId, amount = 9900, customerDetails }) {
  try {
    ...
    try {
      const { revalidatePath } = await import("./worker-entry--gchsNuF.js").then((n) => n.v);
