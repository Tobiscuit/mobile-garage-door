import { W as WriteStream, R as ReadStream, d as requireSafeBuffer, f as getAugmentedNamespace, _ as _process, h as getDefaultExportFromCjs } from "./worker-entry-Dh3Ya8CG.js";
...
function requireEce() {
  ...
  function encryptRecord(key, counter, buffer2, pad, header, last) {
    ...
    if (header.version !== "aes128gcm") {
      ...
      if (!last && padding.length + buffer2.length < header.rs) {
...
function requireWebPushError() {
  ...
  require$$1.inherits(WebPushError, Error);
...
function hasFlag(flag, argv = globalThis.Deno ? globalThis.Deno.args : _process.argv) {
...
function requireNode() {
  ...
  (function(module, exports$1) {
    ...
    try {
      const supportsColor2 = require$$2;
