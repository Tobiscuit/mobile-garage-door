      ...
      <div className="relative w-full md:w-1/2 bg-charcoal-blue flex flex-col justify-center px-8 md:px-16 py-20 group">
        ...
        <div className="relative z-10 max-w-xl mx-auto md:mr-0 md:ml-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="tel:555-000-0000" className="flex items-center justify-center gap-3 bg-red-600 hover:bg-red-500 text-white font-bold py-4 px-8 rounded-xl transition-all shadow-[0_4px_14px_0_rgba(220,38,38,0.39)] hover:shadow-[0_6px_20px_rgba(220,38,38,0.23)] hover:-translate-y-1">
