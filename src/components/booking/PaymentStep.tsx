  ...
  return (
    <div className="space-y-6 animate-fadeIn relative z-10">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500">Secure your slot now. The <span className="text-charcoal-blue font-bold">9 Trip Fee</span> is credited towards your repair.</p>
      </div>
      ...
      <div className="flex gap-4">
        <button onClick={prevStep} disabled={loading} className="w-1/3 text-gray-500 font-bold hover:text-charcoal-blue">BACK</button>
        <button
