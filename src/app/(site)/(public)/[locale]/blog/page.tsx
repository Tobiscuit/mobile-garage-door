                ...
                <div className="container mx-auto px-4 py-24 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter mb-8 leading-none">
                            {t('heading')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-golden-yellow to-yellow-600">{t('heading_accent')}</span>
                        </h1>
            ...
            <div className="container mx-auto px-4 py-16">
                {posts.docs.length === 0 ? (
                    <div className="text-center py-20 bg-white rounded-3xl border border-gray-200 shadow-xl">
                        ...
                        <h3 className="text-2xl font-bold text-charcoal-blue mb-2">{t('no_articles')}</h3>
