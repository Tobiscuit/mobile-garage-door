      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex justify-between text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">
            <span className={step >= 0 ? 'text-charcoal-blue' : ''}>{t('step_contact')}</span>
            <span className={step >= 1 ? 'text-charcoal-blue' : ''}>{t('step_issue')}</span>
            <span className={step >= 2 ? 'text-charcoal-blue' : ''}>{t('step_time')}</span>
            <span className={step >= 3 ? 'text-charcoal-blue' : ''}>{t('step_secure')}</span>
          </div>
